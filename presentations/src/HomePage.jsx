...
function HomePage() {
  ...
  const lectures = [
    ...
    },
    {
      id: 'lecture_2_numpy',
      title: 'NumPy',
      description: 'Master NumPy library to perform efficient operations on data with speed and effectiveness',
    },
    {
      id: 'lecture_3_pandas_part1',
      title: 'Pandas Data Analysis - Part 1',
      description: 'Learn data manipulation and exploration methods with Pandas library',
    },
    {
      id: 'lecture_4_pandas_part2',
      title: 'Pandas Data Analysis - Part 2',
      description: 'Practice data cleaning, grouping, and transformation operations in Pandas',
    },
    {
      id: 'lecture_5_visualization',
      title: 'Data Visualization with Matplotlib & Seaborn',
      description: 'Transform data into meaningful and impressive visualizations using Matplotlib and Seaborn',
    },
    {
      id: 'lecture_6_ml_intro_part1',
